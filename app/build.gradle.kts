...
android {
    namespace = "ru.musikkk.player"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "ru.musikkk.player"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"
    ...
    buildTypes {
        debug {
            buildConfigField("String", "API_BASE_URL", "\"https://musikkk.ru/\"")
        }
        release {
    ...
    lint {
        // Конфигурация лежит в app/lint.xml — там разъясняется,
        // почему UnsafeOptInUsageError отключён для media3-стека.
...
dependencies {
    ...
    // Material Components нужны для XML-темы хоста
